...
import { useUserPositions, useClosePosition } from "../lib/api";
import {
    Dialog,
    DialogContent,
    DialogDescription,
...
export default function ActivePositions({ userId, className }: ActivePositionsProps) {
    ...
    return (
        <Card className={`bg-white border border-gray-100 shadow-card p-6 overflow-hidden flex flex-col ${className || 'h-[600px]'} rounded-4xl`}>
